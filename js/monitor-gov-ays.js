...
$(function(){
    ...
    initData = function(){
        chartMediaLine();//政府各渠道民意变化趋势
        chartMediaPie();//政府渠道民意类型占比
        chartMapCity();//政府渠道民意区域分析
        //newPerson();//政府渠道民意跟踪
    };
    initData();
});
    ...
    var data  = {
        ...
        "data": {
            ...
            "showData": [
                ...
                {"code": "origin02","name": "市长热线", "opinionCount": [24,29,27,10,45,60,42,34,38,10,48,26]},
                {"code": "origin03","name": "信访局", "opinionCount": [14,12,7,16,10,35,20,22,24,20,28,12]},
                {"code": "origin04","name": "公安局", "opinionCount": [4,12,7,16,10,25,20,22,24,20,28,12]},
                {"code": "origin05","name": "督查室", "opinionCount": [6,12,7,16,30,38,30,22,24,20,38,22]},
                {"code": "origin06","name": "民意通", "opinionCount": [16,12,7,16,10,35,26,22,34,20,28,32]}
            ]
        }
    };
    ...
    var data = {
        ...
        "data": {
            ...
            "showData": [
                ...
                {
                    "opinionTypeCode": "mt04",
                    "opinionTypeName": "咨询",
                    "opinionCount": 2132
                },
                {
                    "opinionTypeCode": "mt05",
