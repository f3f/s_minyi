...
function initTimeLine(){
    // 创建滑块(样式需要自行调整).
    var min = new Date("2017-01-01");
    var max = new Date("2017-12-31");

    var defaultBegin = new Date("2017-06-01");
    var defaultEnd = new Date("2017-09-01");
...
function initKeyWords(){
    ...
    var option1 = {
        ...
        series: [{
            ...
            data:[{"value":60,"name":"大数据","itemStyle":{"normal":{"color":"#6cd139"}}},{"value":770,"name":"空气污染","itemStyle":{"normal":{"color":"#ffbd00"}}},{"value":474,"name":"小学教育","itemStyle":{"normal":{"color":"#5daeff"}}},{"value":924,"name":"创业","itemStyle":{"normal":{"color":"#fa7f49"}}},{"value":459,"name":"医疗","itemStyle":{"normal":{"color":"#5daeff"}}},{"value":266,"name":"环境恶化","itemStyle":{"normal":{"color":"#5daeff"}}},{"value":994,"name":"雾霾","itemStyle":{"normal":{"color":"#fa7f49"}}},{"value":160,"name":"废弃物","itemStyle":{"normal":{"color":"#6cd139"}}},{"value":829,"name":"互联网","itemStyle":{"normal":{"color":"#ffbd00"}}},{"value":625,"name":"智慧城市","itemStyle":{"normal":{"color":"#ffbd00"}}}]
        }]
    };
    console.log(JSON.stringify(seriesData1))
